        ...
        highlight_overrides = {
          all = function(colors)
            return {
              ...
              NeoTreeFloatBorder = { bg = colors.mantle, fg = colors.overlay0 },
              ...
              NeoTreeWinSeparator = { fg = colors.overlay0, bg = colors.mantle },
              NormalFloat = { bg = colors.base },
              Pmenu = { bg = colors.mantle, fg = "" },
              PmenuSel = { bg = colors.surface0, fg = "" },
              VertSplit = { bg = colors.base, fg = colors.surface1 },
              WinSeparator = { bg = colors.base, fg = colors.surface1 },
